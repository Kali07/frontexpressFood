          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                <div>
                  <div
                    className={`mx-auto flex h-12 w-12 items-center justify-center rounded-full ${tripInfo.backgroundColor}`}
                  >
                    {tripInfo.icon === "CheckIcon" ? (
                      <CheckIcon
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    >
                      {tripInfo.textForModal}
                    </Dialog.Title>
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Distance de trajet : {tripInfo.distance} km
                        <br />
                        Durée estimée du trajet : {tripInfo.duration}
                      </p>
                    </div>
                  </div>
                </div>
